(function () {
  ...
  function initReviewsCarousel() {
    ...
    if (!track) return;
    const reviews = [
      ["Анна Морозова", "управляющая кафе", "Когда смена горит, хочется видеть людей, ставки и ответы в одном месте. Так проще быстро принять решение."],
      ["Тимур Алиев", "су-шеф", "Для кухни важны точные условия: время, район, ставка и задачи. Когда всё понятно, я откликаюсь быстрее."],
      ["Лейла Х.", "поставщик восточных продуктов", "Заведения часто пишут разрозненно. Формат заявки помогает сразу понять объём, срок и адрес доставки."],
      ["Денис Ким", "бариста", "Мне удобно выбирать смены по времени и району, без долгих переписок и уточнений после отклика."],
      ["Мария Рыжова", "администратор ресторана", "В одном кабинете проще не потерять отклики и понять, кто реально готов выйти на смену."],
      ["Руслан Г.", "управляющий доставкой", "Когда заявки структурированы, можно быстрее закрыть людей на вечер и не держать всё в голове."],
      ["Софья Л.", "хостес", "Хорошо, когда видно формат заведения и часы. Тогда я сразу понимаю, подходит ли смена."],
      ["Александр М.", "поставщик молочной продукции", "Запрос с килограммами, сроками и районом экономит время. Можно сразу дать нормальное предложение."],
      ["Ника Соколова", "официант", "Для меня важны ставка, адрес и окончание смены. Если это указано, решение принимается быстро."],
      ["Иван Петров", "пиццамейкер", "Для подработки важно быстро понять, подходит ли кухня и график. Карточка смены должна отвечать сразу."],
      ["Елена Новикова", "кондитер", "Не хочется каждый раз заново отправлять опыт и контакты. Заполненный профиль сильно экономит время."],
      ["Арман Т.", "сушист", "Если видно район и формат заведения, я быстрее понимаю, готов ли выйти на смену."],
      ["Виктория Белова", "кондитер", "Смены бывают разные, и важно видеть требования заранее: заготовки, десерты, объём и оборудование."],
      ["Алексей Р.", "шеф-повар", "Когда команда неполная, нужен быстрый путь: заявка, отклик, решение."],
      ["Кристина Б.", "уборщица", "Мне важны понятные часы и оплата. Если условия прозрачные, проще брать смены без лишних звонков."],
      ["Дмитрий Орлов", "управляющий баром", "Бармены нужны часто и срочно. Удобно, когда отклики не теряются и видно, кто уже готов выйти."],
      ["Наталья Савина", "поставщик выпечки", "Для поставщика важны регулярные запросы и понятная категория. Так легче отвечать нужным заведениям."],
      ["Роман Х.", "мангальщик", "Хорошо, когда в заявке сразу указаны объём, меню и время. Тогда нет сюрпризов на точке."],
      ["Диана М.", "администратор кафе", "Одна заявка на несколько ролей удобнее, чем искать каждого человека отдельно."],
      ["Кирилл Н.", "оператор кол-центра", "Если заявки и ответы видны в кабинете, меньше путаницы и проще не пропустить важное сообщение."],
      ["Лина Ф.", "бармен", "Для барной смены хочу заранее знать поток, время закрытия и ставку. Тогда можно быстро подтвердить выход."],
      ["Павел Громов", "ресторатор", "Самое ценное — видеть процесс целиком: кто откликнулся, кто приглашён и что уже закрыто."],
      ["Мэй Чжан", "удонщик", "Когда заведение описывает кухню и задачи честно, проще выбрать смену и выйти подготовленным."],
      ["Гурприт Сингх", "поставщик риса и бакалеи", "Запрос с количеством и сроком доставки экономит время обеим сторонам."],
      ["Самира А.", "поставщик соусов", "Категории и фильтры помогают работать с теми, кому реально нужен товар."],
      ["Омар Р.", "кальянщик", "Мне важно видеть формат заведения и часы работы. Тогда я понимаю, подходит ли смена по опыту."],
      ["Алина Котова", "менеджер ресторана", "Когда можно быстро отправить приглашение конкретному работнику, закрывать смены становится спокойнее."],
      ["Фёдор М.", "поставщик рыбы", "Для рыбы критичны сроки и свежесть. Хорошая заявка сразу показывает, что нужно и когда привезти."],
      ["Оксана В.", "сборщик заказов", "Удобно выбирать подработку по району и времени, а не выяснять детали уже после отклика."],
      ["Максим Ли", "курьер", "Если адрес, время и ставка сразу видны, можно быстро взять смену и не тратить день на переписку."]
    ];
